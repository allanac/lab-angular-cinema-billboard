  ...
  movies: any [] = [
    {
      ...
      hours: ['Wed 12:00pm', 'Wed 4:00pm', 'Wed 8:00pm'],
      room: 3
    }, {
      id: 2,
      title: "The Godfather",
      ...
      hours: ['Wed 1:00pm', 'Wed 3:00pm', 'Wed 7:00pm'],
      room: 1
    }, {
      id: 3,
      ...
      hours: ['Wed 2:00pm', 'Wed 4:30pm', 'Wed 6:00pm'],
      room: 2
    }, {
      id: 4,
      ...
      hours: ['Wed 1:45pm', 'Wed 2:40pm', 'Wed 7:40pm'],
      room: 4
    }, {
      ...
      hours: ['Wed 3:00pm', 'Wed 6:00pm', 'Wed 10:00pm'],
      room: 5
    }
  ]
